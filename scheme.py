...
def scheme_eval(expr, env, _=None): # Optional third argument is ignored
    ...
    if scheme_symbolp(first) and first in SPECIAL_FORMS:
        ...
        # BEGIN PROBLEM 5
        "*** YOUR CODE HERE ***"
        # evaluate operator and then check if it's valid
        operator = scheme_eval(first, env)
        check_procedure(operator)
        # evaluate operands by using map method to apply a lambda fn 
        # on every item in Scheme list
        # BEGIN PROBLEM 21
        # if operator is a macro, apply macro to operands
        # don't evaluate operands
        if isinstance(operator, MacroProcedure):
            return scheme_eval(operator.apply_macro(rest, env), env)
        # END PROBLEM 21
        operands = rest.map(lambda value: scheme_eval(value, env))
...
def eval_all(expressions, env):
    ...
    # BEGIN PROBLEM 8
    # Return None if expressions is empty
    # Otherwise return the last evaluated expression
    # recursion doesn't work for tail recursion
...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 3
        "*** YOUR CODE HERE ***"
        # check if symbol is in current frame
        # if symbol is not in current frame, check in parent frame
        # otherwise raise error since symbol hasn't been defined
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        # create a new frame instance and bind each formal parameter to each value in vals
        # raise SchemeError if number of formals and vals aren't the same
        child = Frame(self)
        if len(formals) != len(vals):
            raise SchemeError('{0} and {1} are not the same length'.format(formals, vals))
...
class BuiltinProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        # BEGIN PROBLEM 4
        "*** YOUR CODE HERE ***"
        # append env to python_args if self.use_env is true
        # apply fn to all args in python_args
        try:
            if self.use_env:
                python_args.append(env)
            return self.fn(*python_args)
        except TypeError:
            raise SchemeError('incorrect number of arguments {0}'.format(python_args))
        # END PROBLEM 4
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 12
        "*** YOUR CODE HERE ***"
        # return a new Frame instance using make_child_frame method of appropriate parent frame
        # args is passed in as a parameter for vals
        # new frame should be child of where lambda was defined
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 6
        "*** YOUR CODE HERE ***"
        # evaluate expression and bind to symbol in the environment
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        # target will be a list. First element is the symbol we want to bind to
        # bind lambda function to the symbol. Do not include symbol from target for lambda parameters
...
def do_lambda_form(expressions, env):
    ...
    # parameters are in the first element of expressions and body is in the rest
...
def do_and_form(expressions, env):
    ...
    # BEGIN PROBLEM 13
    "*** YOUR CODE HERE ***"
    # return false if any evaluates to #f
    # evaluates to #t if there are no sub-expressions
    # if expressions is nil:
    #     return True
    # # storing evaluated expression in a variable to prevent duplicate functions calls
    ...
    while expressions is not nil:
        # Evaluate once, return Thunk. If last item, return it either way.
        if expressions.second is nil or scheme_falsep(scheme_eval(expressions.first, env)):
            return scheme_eval(expressions.first, env, True)
        expressions = expressions.second
    return True
    # END PROBLEM 13
...
def do_or_form(expressions, env):
    ...
    # BEGIN PROBLEM 13
    "*** YOUR CODE HERE ***"
    # return false if there are no sub-expressions
    # return value if any sub-expression evaluates to true
    # if expressions is nil:
    #     return False
    # value = scheme_eval(expressions.first, env, True)
    ...
    while expressions is not nil:
        if expressions.second is nil or scheme_truep(scheme_eval(expressions.first, env)):
            return scheme_eval(expressions.first, env, True)
        expressions = expressions.second
    return False
    # END PROBLEM 13
...
def do_cond_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if scheme_truep(test):
            # BEGIN PROBLEM 14
            "*** YOUR CODE HERE ***"
            # test contains a true value or false value
            # return predicate value if there's no sub-expression
            # evaluate all expressions if there are more than one
...
def make_let_frame(bindings, env):
    ...
    # BEGIN PROBLEM 15
    "*** YOUR CODE HERE ***"
    # return a child frame that binds each symbol to each value in bindings
    # value can be an expression
    # check binding structure and formals struture 
...
def do_define_macro(expressions, env):
    ...
    # BEGIN Problem 21
    "*** YOUR CODE HERE ***"
    # create MacroProcedure and bind it to given name like in do_define_form
    check_form(expressions, 2)
    target = expressions.first
    if scheme_symbolp(target):
        check_form(expressions, 2, 2)
...
class MuProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # parent of the call frame is the current environment
...
def optimize_tail_calls(original_scheme_eval):
    ...
    def optimized_eval(expr, env, tail=False):
        ...
        # PROBLEM 20
        "*** YOUR CODE HERE ***"
        # call original scheme eval until it returns a value
